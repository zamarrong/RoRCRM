...
class RequirementsControllerTest < ActionController::TestCase
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post :create, requirement: { budget: @requirement.budget, client_id: @requirement.client_id, date: @requirement.date, description: @requirement.description, user_id: @requirement.user_id }
    end
  ...
  test "should update requirement" do
    patch :update, id: @requirement, requirement: { budget: @requirement.budget, client_id: @requirement.client_id, date: @requirement.date, description: @requirement.description, user_id: @requirement.user_id }
    assert_redirected_to requirement_path(assigns(:requirement))
  end
